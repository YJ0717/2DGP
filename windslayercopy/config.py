...
WIND_CAST_FRAME_WIDTH = 135
WIND_CAST_FRAME_HEIGHT = 220
WIND_CAST_FPS = 10
WIND_CAST_DURATION = 0.5
#============= 스킬 투사체 관련 설정 =========================
WIND_SKILL_FRAME_COUNT = 4
WIND_SKILL_FRAME_WIDTH = 130
WIND_SKILL_FRAME_HEIGHT = 150
WIND_SKILL_FPS = 20
WIND_SKILL_DURATION = 1
WIND_SKILL_SPEED = 300
